  ...
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="Step-by-step form">
        Divide a lengthy or unfamiliar form task into multiple steps to guide the user to complete.
      </n-card>
    </div>
    <n-card :bordered="false" class="mt-4 proCard">
      <n-space vertical class="steps" justify="center">
        <n-steps :current="currentTab" :status="currentStatus">
          <n-step title="Fill in the transfer information" description="Ensure that the correct" />
          <n-step title="Confirm transfer information" description="Confirm transfer information" />
          <n-step title="Complete transfer" description="Congratulations, transfer is successful" />
        </n-steps>
